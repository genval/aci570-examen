...
<h2><?php echo __('Contribution'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($contribution['User']['email'], array('controller' => 'users', 'action' => 'view', $contribution['User']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Reward'); ?></dt>
		<dd>
			<?php echo $this->Html->link($contribution['Reward']['description'], array('controller' => 'rewards', 'action' => 'view', $contribution['Reward']['id'])); ?>
			&nbsp;
		</dd>
